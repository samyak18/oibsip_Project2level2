...
data = pd.read_csv(r"C:\Users\kumar\Downloads\Oasis infobyte internship\Winequalityprediction-Project2-Level2\WineQT.csv")
data.head()
data.describe()
...
Label(master, text="free sulphur", anchor="nw", width=15).grid(row=5)
Label(master, text="Total Sulfur", anchor="nw", width=15).grid(row=6)
...
Label(master, text = "Id", anchor="nw", width=15).grid(row=13)
e1 = Entry(master)
e2 = Entry(master)
e3 = Entry(master)
e4 = Entry(master)
...
Button(master, text='Kumar Samyak',width=17).grid(row=14, column=1, sticky=W, pady=4)
mainloop( )
